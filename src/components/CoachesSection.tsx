...
export function CoachesSection({ language }: CoachesProps) {
  ...
  const mainImage = "https://mmbmcgjqfzmlsibnpbyl.supabase.co/storage/v1/object/sign/Focus/FOTO-HECTOR1-SNI%20MARCA%20DE%20AGUA.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8zZjRmNjhlYS05MmFiLTRkMTItOGZiNi0yMjkzMWI0NTFiYzIiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJGb2N1cy9GT1RPLUhFQ1RPUjEtU05JIE1BUkNBIERFIEFHVUEucG5nIiwic2NvcGUiOiJkb3dubG9hZCIsImlhdCI6MTc4MTQwODY3OSwiZXhwIjoxOTM5MDg4Njc5fQ.tOk1jVQNzGcXj9j_WNfXZVVamUHeWEp7_5fwyrpRpAQ"; 
